...
//   const validateForm = () => {
//     if (!editing && !/^EMP\d*$/i.test(form.empId) && !/^PIPL\d*$/i.test(form.empId)) {
//       return "Employee ID must start with EMP or PIPL followed by digits (e.g., EMP0013 or PIPL0013).";
//     }
//     if (!/^[A-Za-z\s]+$/.test(form.name)) {
...
export default function AdminDashboard() {
  ...
  const validateForm = () => {
    ...
    const duplicate = employees.find(
      (e) => e.mobile === form.mobile && e.empId !== editing
    );
    if (duplicate) {
